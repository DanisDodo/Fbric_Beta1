...
//    self.viewController = [[LLDTableViewController alloc]init];
    self.viewController = [[LLDTestViewController alloc]init];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Fabric_Beta1" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Fabric_Beta1.sqlite"];
